...
/**
 * FabricProductTypeSearch represents the model behind the search form about `common\models\FabricProductType`.
 */
class FabricProductTypeSearch extends FabricProductType
{
    /**
     * @inheritdoc
     */
