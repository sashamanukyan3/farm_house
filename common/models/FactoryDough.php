...
/**
 * This is the model class for table "factory_dough".
 *
 ...
 */
class FactoryDough extends \yii\db\ActiveRecord
{
    const STATUS_NOT_AVAILABLE = 0;
    const STATUS_AVAILABLE = 1;
    const STATUS_READY = 2;//статус готов для поля для самого здания
