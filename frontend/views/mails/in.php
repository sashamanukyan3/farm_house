                        ...
                        <table class="mails-table">
                            ...
                            <?php foreach($mails as $mail){ ?>
                                <tr>
                                    ...
                                    <td class="mails-out-username"><?= $mail->from; ?></td>
                                    <td class="mails-out-subject"><?= $mail->subject; ?></td>
                                    <td class="mails-out-message">
                                        <a href="<?= Url::toRoute('/mails/inview?id=' . $mail->mail_id) ?>"><?= Yii::t('app', 'Просмотр') ?></a>
                                        <a href="<?= Url::toRoute('mails/indelete?id=' . $mail->mail_id) ?>"><?= Yii::t('app', 'Удалить') ?></a>
                                    </td>
                                    <td>
