            ...
            <div class="col-md-3 pag">
                <div class="">
                    ...
                    <div class="frend">
                        ...
                        <div class="botto right-menu-active"><span class="curs"><a href="<?= Url::toRoute('/profile/viewrequests?id=' . $userView->id) ?>"><span style="color: #000"><?= Yii::t('app', 'Заявки') ?></span><span class="badge bmd-bg-info rig"><?php echo $requets_count; ?></span></a></span></div>
                        <div class="botto"><span class="curs"><a href="<?= Url::toRoute('/profile/viewgiftlist?id=' . $userView->id) ?>"><span style="color: #000"><?= Yii::t('app', 'Подарки') ?></span><span class="badge bmd-bg-info rig"><?php echo $giftCount; ?></span></a></span></div></div>
