...
<div class="bmd-page-container padd">
    <div class="container">
        <div class="col-md-7 col-md-offset-3 boxshow">
            <h4 style="text-align:center;"><?= Yii::t('app', 'История обмена средств') ?></h4>
            <hr>
            ...
            <p><a href="#" style="font-weight: bold;"><?= Yii::t('app', 'Обмены средств') ?></a></p>
            ...
            <span><?= Yii::t('app', 'Всего обменено на сумму') ?>: <?= ($allSum) ? $allSum : 0?> <?= mb_strtolower(Yii::t('app', 'Руб')) ?>.</span>
            <table class="table table-striped table-hover ">
                ...
                <tbody>
                <?php if($exchangeHistory): ?>
                    <?php $i=1; foreach($exchangeHistory as $history) : ?>
